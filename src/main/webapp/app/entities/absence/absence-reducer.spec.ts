...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './absence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ABSENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ABSENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ABSENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ABSENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ABSENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ABSENCE actions', async () => {
      const expectedActions = [
        {
