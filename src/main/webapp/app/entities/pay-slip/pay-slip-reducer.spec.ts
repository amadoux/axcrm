...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pay-slip.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYSLIP_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYSLIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYSLIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYSLIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYSLIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYSLIP actions', async () => {
      const expectedActions = [
        {
