...
import { IEnterprise, defaultValue } from 'app/shared/model/enterprise.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IEnterprise> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTERPRISE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENTERPRISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENTERPRISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENTERPRISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENTERPRISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENTERPRISE actions', async () => {
      const expectedActions = [
        {
