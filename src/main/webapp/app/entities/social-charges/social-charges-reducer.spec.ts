...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIALCHARGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOCIALCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIALCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIALCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIALCHARGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIALCHARGES actions', async () => {
      const expectedActions = [
        {
