...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './contract.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACT actions', async () => {
      const expectedActions = [
        {
