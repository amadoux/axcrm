...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Absence}.
 */
@RestController
...
public class AbsenceResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<AbsenceDTO>> getAllAbsences(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
